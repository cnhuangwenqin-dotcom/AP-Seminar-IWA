...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{Environmental Strategies for LEO Broadband Expansion}
\fancyhead[R]{\thepage}
\renewcommand{\headrulewidth}{0pt}
\renewcommand{\footrulewidth}{0pt}

\title{Evaluating the Limits of Environmental Strategies for Sustainable LEO Broadband Expansion}
\author{Wenqin Huang}
\date{\today}
...
% 封面页不需要页眉页脚
\thispagestyle{empty}
\vspace*{2.5in} % 把标题向下推（根据需要调整）
%TC:ignore
\begin{center}
\textbf{
Evaluating the Limits of Environmental Strategies \\
for Sustainable LEO Broadband Expansion
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
